    ...
    <div className={styles.container}>
      ...
      <div className={styles.section2}>
        ...
        <div className={styles.text}>
          ...
          international medical device company. She earns a salary of $110,000
          per year. Katherine has children at university. She’s both style and
          price conscious. She is updating the furniture at the 4 bedroom family
          house. The update in furniture is following the slow remodelling of
          the house now that her kids have left for the university. She finaly
          have the time and resources to express her individual style.
        </div>
