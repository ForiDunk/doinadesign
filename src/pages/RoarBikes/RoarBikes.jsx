  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.text}>
        ...
        everyday objects. His shoes are hand made &amp; his backpack is pink. He
        likes to make his purchase (big or small) from local responsible crafts
        people. He doesn’t own a car. He always brings a reusable cup to the
        coffee shop. Jake cycles to work and wants his bicycle to be practical
        but unique.
      </div>
